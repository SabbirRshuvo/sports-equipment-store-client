  ...
  return (
    <>
      <motion.div
        ...
        className="max-w-3xl mx-auto p-8 bg-slate-200  backdrop-blur-lg shadow-lg rounded-2xl border border-gray-200 mt-12 mb-12"
      >
        ...
        >
          ...
          <div className="col-span-2 flex justify-end mt-4">
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              type="submit"
              className="btn btn-primary flex items-center gap-2 px-5 py-2 text-lg"
            >
